...
\headerbox{Global Self-Supervised Framework}{name=mainSolution,span=2,column=1,row=0}{
}
...
\textbf{Exteroceptive data processing:}

\textbf{Obstacles traversability measurement:}
